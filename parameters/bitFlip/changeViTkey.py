...
if __name__ == '__main__':
    ...
    # 加载原始的.pth文件
    original_path = './vith14/2CIFAR100/frac_1_ep_5.pth'
    ...
    # 保存修改后的参数到新的文件
    new_path = './vith14/2CIFAR100_right_key/frac_1_ep_5.pth'
    ...
    init_keys = torch.load('./vith14/bitFlip/frac_1.pth', map_location=torch.device("mps"))
